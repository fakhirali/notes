...
Here's who'd get hired (most probably). The candidate who made a custom CV for that role, the
CV highlights all the specific aspects that the role required while also mentioning 
everything else. The candidate also sends an email where he describes 
...
app development, web development, game development, etc. If you spend more hours developing,
you'll get more development done, more software gets built. Then there is "engineering",
this is where you are solving a problem, optimizing a solution, improving performance,
increasing reliability, etc. If you spend more hours engineering, you won't make more progress
necessarily. For engineering, you need to analyze, debug, gain insights, acquire 
problem understanding, etc. Which one do you excel at? Which one would you want to be 
better at? AIs can vibe develop, but engineering is harder. I'd want to be the engineer.
Engineering first and developing second sounds like a good mode of programming. 
Solve a problem like an engineer, deliver it to people like a developer. 
